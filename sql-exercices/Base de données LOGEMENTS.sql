...
--Q2
create table INDIVIDU(N_IDENTIFICATION int primary key,N_LOGEMENT int,NOM varchar(30),PRENOM varchar(30),DATE_DE_NAISSANCE date,N_TELEPHONE varchar(30))
create table LOGEMENT(N_LOGEMENT int primary key,TYPE_LOGEMENT varchar(30),ID_QUARTIER int,NO int,RUE varchar(30),SUPERFICIE float,LOYER float)
create table QUARTIER(ID_QUARTIER int primary key,ID_COMMUNE int,LIBELLE_QUARTIER varchar(30))
create table TYPE_DE_LOGEMENT(TYPE_LOGEMENT varchar(30) primary key,CHARGES_FORFAITAIRES varchar(30))
create table COMMUNE(ID_COMMUNE int primary key,NOM_COMMUNE varchar(30),DISTANCE_AGENCE float ,NOMBRE_D_HABITANTS int)
